...
import com.ashish.mymusic.databinding.FragmentNowPlayingBinding
...
//        this two will send the intent to 'PlayerActivity' when now playing fragment is clicked
    ...
    override fun onResume() {
        ...
        if (PlayerActivity.musicService!=null)
        {
            ...
            binding.songNameNP.isSelected=true //to make our song name movable
            Glide.with(this)
                .load(PlayerActivity.musicListPA[PlayerActivity.songPosition].artUri)
                .apply(RequestOptions().placeholder(R.drawable.music_note).centerCrop())
                .into(binding.songImgNP)
